...
- [x] **Phase 1: FTP Endpoint Contract & Routing** - Make FTP endpoints configurable and reachable through existing factory paths. (completed 2026-04-24)
...
|-------|----------------|--------|-----------|
| 1. FTP Endpoint Contract & Routing | 2/2 | Complete | 2026-04-24 |
