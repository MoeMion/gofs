# Requirements Archive: v2.0 FTP Sync Library
...
- [x] **ONCE-02**: Developer can run one-shot FTP→local disk synchronization through `FTPSyncService`
...
- [x] **ONCE-04**: One-shot sync never writes files to the process working directory unless that directory is explicitly configured as the local endpoint
...
| ONCE-02 | Phase 6 | Complete |
| ONCE-03 | Phase 6 | Complete |
| ONCE-04 | Phase 6 | Complete |
...
*Last updated: 2026-04-28 after v2.0 milestone archive; ONCE-02 and ONCE-04 source-of-truth drift reconciled from audit evidence*
